...
public class Panel_Paciente extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lista_historial.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "01/01/2021 - Embarazo", "02/02/2022 - Ovario Poliquostico", "03/03/2023 - Infección" };
